...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "session_list_limit": "Sessions Listed",
        "session_list_limit_desc": "Keep the expanded list to the most recently active sessions",
        "all_sessions": "All",
        "latest_1_session": "Latest only",
        "n_sessions_hidden": "%d older hidden",
    ...
    private static let de: [String: String] = en.merging([
        ...
        "session_list_limit": "Gelistete Sitzungen",
        "session_list_limit_desc": "Die ausgeklappte Liste auf die zuletzt aktiven Sitzungen begrenzen",
        "all_sessions": "Alle",
        "latest_1_session": "Nur neueste",
        "n_sessions_hidden": "%d ältere ausgeblendet",
    ...
    private static let zh: [String: String] = [
        ...
        "session_list_limit": "列表会话数量",
        "session_list_limit_desc": "展开列表只保留最近活跃的会话",
        "all_sessions": "全部",
        "latest_1_session": "仅最近 1 个",
        "n_sessions_hidden": "已隐藏 %d 个较早会话",
    ...
    private static let zhHant: [String: String] = [
        ...
        "session_list_limit": "列表會話數量",
        "session_list_limit_desc": "展開列表只保留最近活躍的會話",
        "all_sessions": "全部",
        "latest_1_session": "僅最近 1 個",
        "n_sessions_hidden": "已隱藏 %d 個較早會話",
    ...
    private static let ja: [String: String] = [
        ...
        "session_list_limit": "一覧に表示するセッション数",
        "session_list_limit_desc": "展開したリストを最近アクティブなセッションだけに絞ります",
        "all_sessions": "すべて",
        "latest_1_session": "最新の1件のみ",
        "n_sessions_hidden": "古いセッション %d 件を非表示",
    ...
    private static let ko: [String: String] = [
        ...
        "session_list_limit": "목록에 표시할 세션 수",
        "session_list_limit_desc": "펼친 목록을 최근 활동한 세션으로 제한합니다",
        "all_sessions": "전체",
        "latest_1_session": "최근 1개만",
        "n_sessions_hidden": "이전 세션 %d개 숨김",
    ...
    private static let tr: [String: String] = [
        ...
        "session_list_limit": "Listelenen Oturumlar",
        "session_list_limit_desc": "Genişletilmiş listeyi en son etkin oturumlarla sınırla",
        "all_sessions": "Tümü",
        "latest_1_session": "Yalnızca en yenisi",
        "n_sessions_hidden": "%d eski oturum gizli",
